...
describe PgPower::ConnectionAdapters::Table::CommentMethods do
  class AbstractTable
  ...
  it ".set_table_comment" do
    base.should_receive(:set_table_comment).with("sometable", "somecomment")
    table_stub.set_table_comment("somecomment")
  end

  it ".remove_table_comment" do
    base.should_receive(:remove_table_comment).with("sometable")
    table_stub.remove_table_comment
  end

  it ".set_column_comment" do
    base.should_receive(:set_column_comment).with("sometable", "somecolumn", "somecomment")
  ...
  it ".remove_column_comment" do
    base.should_receive(:remove_column_comment).with("sometable", "somecolumn")
    table_stub.remove_column_comment("somecolumn")
  end

  it ".remove_column_comments" do
    base.should_receive(:remove_column_comments).with("sometable", "column1", "column2")
