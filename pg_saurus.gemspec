...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<psych>.freeze, [">= 0".freeze])
  s.add_runtime_dependency(%q<railties>.freeze, ["< 9".freeze])
  s.add_runtime_dependency(%q<activemodel>.freeze, ["< 9".freeze])
  s.add_runtime_dependency(%q<activerecord>.freeze, ["< 9".freeze])
  s.add_runtime_dependency(%q<activesupport>.freeze, ["< 9".freeze])
  s.add_development_dependency(%q<rspec-rails>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<yard>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<metric_fu>.freeze, [">= 0".freeze])
